...
class TestGenerateReportAnalysis(unittest.TestCase):
    """测试财务分析报告生成功能"""
    ...
    @patch("src.reporting.generate_report_analysis.OpenAI")
    def test_generate_report_analysis(self, mock_openai):
        """测试使用OpenAI生成财务分析报告"""
        # 模拟OpenAI客户端
        ...
        mock_file_content.read.return_value = b"test report content"
